...
def delete_ccdc_solvents(system: list[Atom], pbc: PBC):
    ...
    for idx, mol in enumerate(mols):
        ...
        if mol_elements == ["H", "H", "O"]:
            ...
            lone_mols.append(mol)
        elif mol_elements == ["H", "H", "C", "Cl", "Cl"]: # DCM
            lone_mols.append(mol)
        elif mol_elements == ["H", "H", "H", "H", "H", "H", "H", "C", "C", "C", "N", "O"]: # DMF
            lone_mols.append(mol)
        elif mol_elements == ["H", "H", "H", "C", "C", "N"]: # Acetonitrile
            lone_mols.append(mol)
        elif mol_elements == ["H", "H", "H", "N"]: # Ammonia
            lone_mols.append(mol)
        elif mol_elements == ["H", "H", "H", "H", "H", "H", "C", "C","O", "S"]: # DMSO
            lone_mols.append(mol)
...
def delete_lone_non_metals(system: list[Atom], pbc: PBC) -> list[Atom]:
    lone_atoms = []
    for atom in progressbar(system):
        lone_atom = True
